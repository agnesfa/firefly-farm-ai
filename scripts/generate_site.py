...
/* Status messages — fixed-position toast so the confirmation is visible
   regardless of form length. Long inventory forms used to scroll the status
   message off-screen, causing duplicate submissions. See claude-docs/
   ux-review-deferred-2026-04-23.md. */
.obs-status {
  position: fixed;
  top: 16px;
  left: 50%;
